...
> Arquivo gerado automaticamente por `scripts/scaffold.py` em 2026-04-27T15:36:13Z
...
| Campo | Valor |
|-------|-------|
| **Nome** | `portfolio-generator` |
| **Título** | Test Workspace Fix |
...
```
Modo: PROGRAMMING. Projeto: portfolio-generator. Perfil: devops-programming.
```
...
|------|---------|-----------|
| 2026-04-27T15:36:13Z | Scaffold inicial criado | Domínio: programming, Linguagem: python |
...
*Gerado por scripts/scaffold.py v1.0.0 | 2026-04-27T15:36:13Z*
